...
2. **MCP Server** (`python/fxhoudinimcp/`): A standalone Python process using FastMCP. Exposes 186 tools, 8 resources, and 8 prompts via the MCP protocol. Forwards tool calls to Houdini over HTTP.
