...
**167 tools**, **8 resources**, and **7 workflow prompts** out of the box.
...
2. **MCP Server** (`python/fxhoudinimcp/`): A standalone Python process using FastMCP. Exposes 167 tools, 8 resources, and 7 prompts via the MCP protocol. Forwards tool calls to Houdini over HTTP.
