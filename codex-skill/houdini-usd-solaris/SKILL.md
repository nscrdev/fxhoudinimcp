...
- Preserve existing node positions. Do not call `layout_children` as routine cleanup; only use it when the user explicitly asks for layout/cleanup, or inside a newly created isolated stage network/subnet.
